...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'yeU1iKVizwUtwLT9xGfKNK1XEMM2POqqHjX46qwAVZrGR'
...
# Twitter credentials
consumer_key = 'T1CouYrXLQKYuIDMtFDO0a1y4'
consumer_secret = 'Xqmw1NOvPjH9Nvj1c16wt9d48N2JfcvfxUccwLkAeUm4VppyKP'
access_key = '1571050546190225411-xXmIGKO9iIImlyWD89XwtWZKPqntyJ'
access_secret ='yeU1iKVizwUtwLT9xGfKNK1XEMM2POqqHjX46qwAVZrGR'

# Pass your twitter credentials to tweepy via its OAuthHandler
auth = OAuthHandler(consumer_key, consumer_secret)
auth.set_access_token(access_key, access_secret)
t_api = tweepy.API(auth)
"""t_api = tweepy.Cursor(auth, wait_on_rate_limit=True, wait_on_rate_limit_notify=True)"""
...
tokenizer = tokenizers.ByteLevelBPETokenizer(
    vocab_file=PATH+'svocab-roberta-base.json', 
